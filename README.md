...
# Usage (Windows)
1. Download (rscoopwindows.exe)[https://github.com/barpyfartz/AndroidRScoop/releases/tag/release] and android roblox apk
...
# Usage (Linux)
1. Download (rscooplinux)[https://github.com/barpyfartz/AndroidRScoop/releases/tag/release] and android roblox apk
